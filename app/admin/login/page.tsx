...
export default function AdminLoginPage() {
  ...
  const handleDiscordLogin = () => {
    ...
    window.location.href = `/api/auth/discord?redirect_uri=${encodeURIComponent(redirectUri)}`
  }
        ...
        <Card className="w-full max-w-md border-4 border-christmas-red/20 bg-white/95 shadow-2xl backdrop-blur">
          ...
          <CardContent className="space-y-4">
            ...
            <Button
              ...
              disabled={isLoading !== null}
              className="w-full bg-white text-gray-700 hover:bg-gray-50 border-2 border-gray-300"
              size="lg"
            >
              {isLoading === "google" ? (
                "Redirecting..."
            ...
            <div className="rounded-lg border-2 border-christmas-gold/30 bg-christmas-gold/10 p-4">
              <p className="text-center text-sm text-foreground/80">
                Only pre-approved administrators can access the admin panel. Contact your system administrator if you
                need access.
              </p>
            </div>
          </CardContent>
